...
const Contact = () => {
    return (
        <div className='grid justify-center items-center my-10'>
            ...
            <h2 className='text-2xl font-bold text-primary'>Contact with Us</h2>
            </div>
	...
	<div class="cube-5 w-300 cube">
		<div class="front">
			<input type="text" name="name" id="name" placeholder="Your Name" class="field text-white"/>
		</div>
		<div class="back"></div>
		<div class="top"></div>
		<div class="bottom"></div>
	...
	<div class="cube-12 w-300 cube">
		<div class="front">
			<input type="email" name="email" id="email" placeholder="Your Email" class="field text-white"/>
		</div>
		<div class="back"></div>
		<div class="top"></div>
		<div class="bottom"></div>
	...
	<div class="cube-22 w-300 cube">
		<div class="front">
			<textarea name="message" id="message" placeholder="Message" class="field textarea text-white"></textarea>
		</div>
		<div class="back"></div>
		<div class="top"></div>
		<div class="bottom"></div>
	...
	<div class="cube-28 w-100 cube">
		<div class="front">
			<label for="gossip" class="label text-white">Gossip</label>
		</div>
		<div class="back"></div>
		<div class="top"></div>
		<div class="bottom"></div>
	...
	<div class="cube-31 w-300 cube">
		<div class="front">
			<input type="text" name="gossip" id="gossip" placeholder="How did you hear about us?" class="field text-white"/>
		</div>
		<div class="back"></div>
		<div class="top"></div>
		<div class="bottom"></div>
